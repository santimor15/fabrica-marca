...
export const ASSET_TYPES: AssetType[] = [
  ...
  },
  {
    id: "historia-novedad",
    categoriaId: "redes",
    nombre: "Historia — Novedad",
    descripcion: "1080 × 1920 — conjunto nuevo o disponible, sin foco en descuento",
    formatoExport: "png",
    ancho: 1080,
    alto: 1920,
    campos: [CAMPO_TITULO, CAMPO_TEXTO, CAMPO_DATOS_CLAVE, CAMPO_IMAGEN],
  },
  {
    id: "historia-promo",
    categoriaId: "redes",
    nombre: "Historia — Promo",
    descripcion: "1080 × 1920 — descuento o promoción con urgencia",
    formatoExport: "png",
    ancho: 1080,
    alto: 1920,
    campos: [CAMPO_TITULO, CAMPO_TEXTO, CAMPO_DATOS_CLAVE, CAMPO_IMAGEN],
